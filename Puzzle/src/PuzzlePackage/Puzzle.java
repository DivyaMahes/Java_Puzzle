...
import javax.swing.JOptionPane;
	...
	{ 
		...
		b1=new JButton("5"); b1.setBounds(100,150,50,50);
		b2=new JButton("3"); b2.setBounds(150,150,50,50);
		b3=new JButton("2"); b3.setBounds(200,150,50,50);
		b4=new JButton("1"); b4.setBounds(100,200,50,50);
		b5=new JButton("4"); b5.setBounds(150,200,50,50);
		b6=new JButton("7"); b6.setBounds(200,200,50,50);
		b7=new JButton("6"); b7.setBounds(100,250,50,50);
		b8=new JButton(""); b8.setBounds(150,250,50,50);
		b9=new JButton("8"); b9.setBounds(200,250,50,50);
		
		reset=new JButton("Reset"); reset.setBounds(150,350,75,40);
		...
		frame.setVisible(true);
		  ...
		  {
			  b1.setText("5"); b2.setText("3"); b3.setText("2"); b4.setText("1");
			  b5.setText("4"); b6.setText("7"); b7.setText("6"); b8.setText(""); b9.setText("8");
		  }
